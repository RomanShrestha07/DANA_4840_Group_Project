...
hc_average <- hclust(d = dist(mtcars), method = "average")
hc_complete <- hclust(d = dist(mtcars), method = "complete")
...
# Plot tanglegram
tanglegram(average_dendrogram, complete_dendrogram, main = "Tanglegram: Average vs. Complete Linkage", color_lines = color_palette)
```
...
tanglegram(
  average_dendrogram,
  complete_dendrogram,
  # main = "Tanglegram: Average vs. Complete Linkage",
...
```{r}
dendextend::tanglegram(average_dendrogram, complete_dendrogram)
```

```{r}
#Customized the tanglegram using many other options as follow:
tanglegram(average_dendrogram, complete_dendrogram,
           highlight_distinct_edges = FALSE, #Turn-off dashed lines
           common_subtrees_color_lines = FALSE, #Turn-off line colors
           common_subtrees_color_branches = TRUE, #Color common branches
