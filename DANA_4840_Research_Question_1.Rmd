...
```
Finally, visually UMAP provides clusters that are very well-separated with no overlap. With an Adjusted Rand Index of 0.77, it shows the highest improvement in the performance of the clustering method.
