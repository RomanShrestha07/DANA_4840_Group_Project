...
```{r}
wdbc <- read.table("data/wdbc_kaggle.csv", header = T, sep = ",")
head(wdbc)
```
...
```{r}
wdbc_silhouette_kmeans <- fviz_nbclust(wdbc, kmeans, method = "silhouette0") + labs(title = "K-means Silhouette Method")
