...
**TO DO: Interpretation of stability**

From chatGPT - I don't want to take something  I don't understand - Overall, hierarchical clustering shows the highest stability in terms of APN and ADM, especially with 2 clusters. The PAM method, while having the lowest AD score, indicates stable centroids but not necessarily the best clustering quality. K-Means provides the best clustering quality (lowest FOM) but is less stable than hierarchical clustering according to APN and ADM metrics.
